...
describe("9. a floor that protects nothing is released, not wasted", () => {
  ...
  it("6/13. the floor is NOT released because the controller finished", async () => {
    ...
    // reservation is now the contract's actual remaining demand — TWO
    // guaranteed anchor reads on this contract, since SOURCE_OF_VALUE no
    // longer maps to an anchor-level intent.
