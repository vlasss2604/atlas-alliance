...
export function reconcileComponent(input: ComponentReconciliationInput): ComponentReconciliationResult {
  ...
  //
  // THE TWO-CODE DISTINCTION IS PRESERVED, deliberately: "no typed gross
  // reduction at all" and "a burn, but no measured interval" are different
  // states of the record and keep different codes.
  //
