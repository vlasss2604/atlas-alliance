...
// Re-exported so this module stays the phased path's single import
// surface; the policy itself is defined once, next door.
export { plannedFallbacks } from "./acquisition-fallback-policy";
import {
