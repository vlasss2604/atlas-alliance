...
**Статус: ожидает `ANTHROPIC_API_KEY`.** Проводка проверена на fake
gateway (20/20 вызовов без сбоев схемы) — это проверка механики,
не понимания. Фаза 4 не закрывается до живого прогона.
